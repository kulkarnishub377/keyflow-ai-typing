...
## Role
Coach owns one narrow part of KeyFlow's adaptive typing workflow. It may only act on validated inputs and must not exceed the authority described in `AGENTS.md`.
